...
public class DBAlertEachOne extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "AlertEach.db";
    public static final String CONTACTS_TABLE_NAME = "alerteach";
    ...
    public DBAlertEachOne(Context context) {
