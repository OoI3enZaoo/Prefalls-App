...
public class DBAlertAll extends SQLiteOpenHelper {
    ...
    public Cursor getAllData() {
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery("select "+CONTACTS_COLUMN_NAME+","+CONTACTS_COLUMN_TYPE+", "+CONTACTS_COLUMN_IMAGE+" ,"+CONTACTS_COLUMN_TIME+" ,"+CONTACTS_COLUMN_LAT+","+CONTACTS_COLUMN_LONG+" ,"+CONTACTS_COLUMN_COLOR+ " from " + CONTACTS_TABLE_NAME +" ORDER BY " + CONTACTS_COLUMN_TIME + " DESC limit 10", null);
        return res;
